...
| # | Task | Priority | Notes |
|---|------|----------|-------|
| 1 | Live-verify Phase 78's deferred full-page PDF compile once pushed | High — needs Render redeploy | Confirm Download PDF and Share wait for `pdfPending` to clear (no 404s), then work normally once the PDF is ready. |
