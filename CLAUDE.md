...
| 8 | Committed, not pushed | `c0e8c15` | Ready for Sohyun to push from her Terminal. |
...
| # | Task | Priority | Notes |
|---|------|----------|-------|
| 1 | Live-verify Phase 84 through 88 once pushed | High | Not yet pushed -- confirm on the live site: timeline.html's entry button reads "Piano exam" (not "AMEB Piano exam", `21214f4`); the Sight-Reading Generator's header "Piano Butler" logo now navigates to the homepage when clicked (`1e214e3`); timeline.html's free-text label + focus-area checklist flow works end to end (Phase 86, `21423a5`); the homepage no longer shows any exam-year text next to AMEB/ABRSM/Trinity (Phase 87, `12276c9`); and timeline.html's local checkbox tracking + "Email me this plan" button both actually work in a real browser, including a reload correctly resuming a saved plan (Phase 88, `c0e8c15` -- already live-tested in headless Chromium this session, but per this project's standing rule and the Phase 88 #5 lesson, a locally-run test is not a substitute for a real spot-check on the deployed site). |
