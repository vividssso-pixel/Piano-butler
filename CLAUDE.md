...
| 9 | Sight-reading generator — add a "may take up to a minute" loading message | Low | Live-verified 2026-09-15: works correctly but takes ~40–50s (Render free-tier cold start + LilyPond compile) with only a static "Engraving your excerpt…" message. Cheap fix, avoids the "looks broken" impression. |
...
folded into the Revenue-critical table instead of its own pending-work line). Removed 2026-08-17:
